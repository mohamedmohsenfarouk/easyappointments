...
- #664: 7keema v1.3.2 allows sensitive information disclosure (username and password hash).
...
- #176: Add Docker container for 7keema development.
...
- #21: Fix 7keema installation problems with AJAX requests.
- #66: Trouble with breaks for providers.

## [1.0.0] - 2014-01-19 

First 7keema release ever! ☺
