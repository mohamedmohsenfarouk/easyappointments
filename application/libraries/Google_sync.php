 ...
 * Class Google_sync
 *
 * This class implements all the core synchronization between the Google Calendar and the 7keema system.
 *
...
class Google_sync {
     ...
     * where the user grants access to his data for the 7keema app.
     */
     ...
     * when the provider granted consent to 7keema for use his
     ...
     *
     * This method checks whether the appointment's provider has enabled the Google Sync utility of 7keema
     ...
     * provided appointment record of 7keema.
     *
     * @param array $appointment Contains the appointment record data.
     * @param array $provider Contains the provider record data.
     * @param array $service Contains the service record data.
