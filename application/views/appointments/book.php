                ...
                <div class="frame-container">
                    ...
                    <div class="col-12 col-md-6">
                        <form id="register_user" method="post" action="<?php echo base_url(); ?>index.php/register/validation">
                            ...
                            <input type="text" name="user_email" id="email" class="form-control" value="<?php echo set_value('user_email'); ?>" />
                            <span class="text-danger"><?php echo form_error('user_email'); ?></span>
                            </div>
                            <div class="form-group">
                            <label>Enter Password <span class="text-danger">*</span></label>
                            <input type="password" name="user_password" id="password" class="form-control" value="<?php echo set_value('user_password'); ?>" />
                            <span class="text-danger"><?php echo form_error('user_password'); ?></span>
                            </div>
                            <div class="form-group">
                            <label>Enter Phone Number <span class="text-danger">*</span></label>
                            <input type="number" name="phone_number" id="phone_number" class="form-control" value="<?php echo set_value('phone_number'); ?>" />
                            <span class="text-danger"><?php echo form_error('phone_number'); ?></span>
                            </div>
                            <div class="form-group">
                            <input type="button" name="register" id="register_btn" value="Register" class="register_button btn btn-info" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" id="loginUser">Login</a>
                            </div>
                        ...
                        <div id="show_login_form" style="display: none;">
                            <form method="post" id="login_user" action="<?php echo base_url(); ?>index.php/login/validation">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="button" name="login" id="login_btn" value="Login" class="btn btn-info login_button" />
                                </div>
                ...
                <div class="frame-container">
                    ...
                    <div class="row frame-content">
                       ...
                       <div class="form-group">
                            ...
                            class="form-control" value="<?php echo $user_customer_query->result()[0]->first_name; ?>" />
                        </div>

                        <div class="form-group">
                            <label>Last Name</label>
                            <input type="text" name="last_name" id="last_name"
                            class="form-control" value="<?php echo $user_customer_query->result()[0]->last_name; ?>" />
                        </div>
                        <div class="form-group">
                            <label>Email Address</label>
                            <input type="text" name="user_email" id="email"
                            class="form-control" value="<?php echo $user_customer_query->result()[0]->email; ?>" />
                        </div>

                        <div class="form-group">
                            <label>Phone Number</label>
                            <input type="number" name="phone_number" id="phone_number"
                             class="form-control" value="<?php echo $user_customer_query->result()[0]->phone_number; ?>" />
                        </div>
                        </div>
