...
<head>
    ...
    <title>Installation | 7keema</title>
...
<header>
    <div class="container">
        <h1 class="page-title">7keema Installation</h1>
    </div>
</header>

<div class="content container">
    <div class="welcome">
        <h3>Welcome to the 7keema installation page.</h3>
        <p>
            This page will help you set the main settings of your 7keema installation.
            ...
            url to connect to the backend section of 7keema.

            If you face any problems during the usage of 7keema you can always check the
    ...
    <p>
    <h3>License</h3>
    7keema is licensed under the <span class="badge badge-default">GPL-3.0 license</span>.
    By using the code of 7keema in any way <br> you agree with the terms described in the
    following url:
