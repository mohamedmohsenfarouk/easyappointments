...
(function() {
    ...
    CustomersHelper.prototype.bindEventHandlers = function() {
        ...
        $(".delete-customer").on("click", function() {
            var customerId = $(this).attr("data-title");
    ...
    CustomersHelper.prototype.save = function(customer) {
        var url =
            GlobalVariables.baseUrl + "/index.php/backend_api/ajax_save_customer";
    ...
    CustomersHelper.prototype.delete = function(id) {
        var url =
            GlobalVariables.baseUrl + "/index.php/backend_api/ajax_delete_customer";
    ...
    CustomersHelper.prototype.filter = function(key, selectId, display) {
        ...
        var url =
            GlobalVariables.baseUrl + "/index.php/backend_api/ajax_filter_customers";
